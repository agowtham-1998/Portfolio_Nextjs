...
export default function Home() {
  return (
    <>
      ...
      <Navbar />
      <section className="min-h-screen px-6 md:px-10 max-w-7xl mx-auto flex flex-col items-center justify-center text-center bg-gradient-to-br from-sky-100 via-white to-blue-100 font-[Poppins]">
        ...
        <p className="text-xl md:text-2xl text-gray-700 max-w-3xl mb-10">
          React Native Developer building cross-platform mobile apps and modern
          UI kits for businesses and developers.
        </p>
