      ...
      <main className="max-w-6xl mx-auto p-8 mt-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          <div className="p-6 bg-white rounded-3xl shadow-lg hover:scale-105 transition transform">
            <img src="/images/shanthi_jewllers.png" alt="Shanthi Jewellers" className="rounded-lg shadow" />
          ...
          <div className="p-6 bg-white rounded-3xl shadow-lg hover:scale-105 transition transform">
          <img src="/images/sur4plots.png" alt="Sur4plots" className="rounded-lg shadow" />
          ...
          <div className="p-6 bg-white rounded-3xl shadow-lg hover:scale-105 transition transform">
           <img src="/images/ayuryogams.png" alt="Ayuryogams" className="rounded-lg shadow" />
