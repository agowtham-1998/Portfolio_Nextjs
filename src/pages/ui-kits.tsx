  ...
  return (
    <>
      ...
      <main className="max-w-6xl mx-auto p-8 mt-24">
        <h1 className="text-4xl font-bold mb-8">React Native UI Kits for Sale</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          <div className="p-6 bg-white rounded-3xl shadow-lg hover:scale-105 transition transform">
            <h2 className="text-2xl font-bold text-blue-700 mb-2">E-Commerce UI Kit</h2>
            <p className="text-gray-600">20+ screens | Expo | Light & Dark Mode</p>
